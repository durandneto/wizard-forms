...
export default function PreviousTreatment() {
  ...
  const handleChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    CancerDispatch({
      type: CANCER_UPDATE,
      key: "previousClinicalTestingResults",
      value: {
        ...CancerState.Diagnostic.previousClinicalTestingResults,
  ...
  return (
    <Accordeon
      noBorder
      title="Previous Clinical Testing Results"
      highlight
      control
      initialClosed
    >
      <Grid container spacing={3}>
        <Grid item xs={12}>
          <TextField
            ...
            label={"Germline testing results"}
            /**
