...
export const submitForm = (AppData: any) => {
  ...
  const postData: saveDataInterface = {
    ...
    extendedMedicareLeadData:
      AppData.Profile.tabs.MediCare.data.extendedMedicareLeadData,
    ...
    cardiacInformation: {
      ...
      prescribedMedications:
        AppData.Cardiac.tabs.Diagnostic.data.prescribedMedications,
  ...
  return axios
    .post(`${BASE_URL}/medicare`, postData, axiosConfig)
